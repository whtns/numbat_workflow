...
qc_dirs <- c("~/single_cell_pipeline/output/FACS_20170407_sunlee_H_sapiens_output/multiqc_data/", "~/single_cell_pipeline/output/FACS_20171031_sunlee_H_sapiens_output/multiqc_data/")
...
```{r write_scone_stats, warning=FALSE}

# scone_qc_path <- paste0(qc_dir, "scone_qc.txt")

scone_qc_path <- paste0("~/single_cell_pipeline/output/merged_analyses/FACS_20170407_sunlee_FACS_20171031/", "scone_qc.txt")
...
sunlee_all <- readRDS("~/single_cell_pipeline/output/merged_analyses/FACS_20170407_sunlee_FACS_20171031/FACS_20170407_sunlee_FACS_20171031_singlecellexperiment.rds")

# sunlee_1031 <- readRDS("~/single_cell_pipeline/output/FACS_20171031_sunlee_H_sapiens_output/FACS_20171031_sunlee_H_sapiens_summarized_experiment.rds")
...
sunlee_all <- SingleCellExperiment(assays=list(counts=assays(sunlee_all)$counts), colData=sample_metadata, rowData=rowData(sunlee_all))
...
#Batch - Variation to be removed
batch = factor(colData(goodDat)$seq_run)
...
my_scone <- scone(my_scone,
                  scaling=scaling,
                  run=TRUE,
                  eval_kclust = 2:3,stratified_pam = TRUE,
                  return_norm = "no",
                  zero = "postadjust")
...
# write.csv(colData(goodDat), "~/single_cell_pipeline/output/merged_analyses/FACS_20170407_sunlee_20121031_scone_meta.csv")
...
`none,fq,ruv_k=3,no_bio,no_batch` performs well compared to other normalization
